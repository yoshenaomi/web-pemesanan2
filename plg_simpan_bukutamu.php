...
<head>
  ...
  <style>
    ...
    align-items: center;
    height: 100vh; /* Untuk mengisi tinggi layar penuh */
}

.card {
    /* Gaya tambahan untuk kartu jika diperlukan */
}
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       ...
       <h1 class="mb-0 bread">Buku Tamu</h1>
     </div>
   </div>
 </div>
</section>
<?php include 'koneksi.php'; 
        ...
        $id_pelanggan = $_SESSION['last_insert_id'];
        $data = mysqli_query($conn, "select * from tbl_bukutamu where id_pelanggan='$id_pelanggan'");
