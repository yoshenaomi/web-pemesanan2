  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Beranda <i class="fa fa-chevron-right"></i></a></span> <span>Paket Hotel <i class="fa fa-chevron-right"></i></span></p>
         <h1 class="mb-0 bread">Paket Hotel</h1>
     </div>
 </div>
</div>
</section>
			...
			<div class="container">
				<div class="row justify-content-center pb-4">
					<div class="col-md-12 heading-section text-center ftco-animate">
						<span class="subheading">Penawaran Spesial Dari Kami</span>
						<h2 class="mb-4">Penawaran</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/satu.webp);">
								<span class="price">Standar</span>
							</a>
							<div class="text p-4">
								<span class="days">200.000</span>
								<h3><a href="#">SaveCation</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Jl. Raya Jember KM 7, Krajan, Dadapan, Kabat, Banyuwangi, Jawa Timur 68461</p>
								<a href="plg_form_paket.php" class="btn btn-primary py-2 px-2">Pesan</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/dua.webp);">
								<span class="price">Deluxe</span>
							</a>
							<div class="text p-4">
								<span class="days">600.000</span>
								<h3><a href="#">Food</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Jl. Raya Jember KM 7, Krajan, Dadapan, Kabat, Banyuwangi, Jawa Timur 68461</p>
								<a href="plg_form_paket.php" class="btn btn-primary py-2 px-2">Pesan</a>
							</div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/tiga.webp);">
								<span class="price">Executif</span>
							</a>
							<div class="text p-4">
								<span class="days">200.000</span>
								<h3><a href="#">SaveCation</a></h3>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/empat.webp);">
								<span class="price">Standar</span>
							</a>
							<div class="text p-4">
								<span class="days">800.000</span>
								<h3><a href="#">Family Staycation</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span>Jl. Raya Jember KM 7, Krajan, Dadapan, Kabat, Banyuwangi, Jawa Timur 68461</p>
								<a href="plg_form_paket.php" class="btn btn-primary py-2 px-2">Pesan</a>
							</div>
						</div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/lima.webp);">
								<span class="price">Deluxe</span>
							</a>
							<div class="text p-4">
								<span class="days">400.000</span>
								<h3><a href="#">SaveCation</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span>Jl. Raya Jember KM 7, Krajan, Dadapan, Kabat, Banyuwangi, Jawa Timur 68461</p>
								<a href="plg_form_paket.php" class="btn btn-primary py-2 px-2">Pesan</a>
							</div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/baru/enam.webp);">
								<span class="price">Executif</span>
							</a>
							<div class="text p-4">
								<span class="days">200.000</span>
